...
export const opMap: Map<number, Operation> = new Map<number, Operation>([
    [0xA9, {method: ops.lda, addrMode: addrModes.IMMEDIATE, argType: argTypes.immediate, cycles: 2}],
    ...
    [0x85, {method: ops.sta, addrMode: addrModes.ZEROPAGE, argType: argTypes.immediateValue, cycles: 3}],
